...
use Fossology\Lib\Application\UsersCsvImport;

/**
 * \brief Upload a file from the users computer using the UI.
 */
class UsersFromCSV extends DefaultPlugin
{
  const NAME = "users_from_csv";
  const KEY_UPLOAD_MAX_FILESIZE = 'upload_max_filesize';

  function __construct()
  {
    parent::__construct(self::NAME, array(
        self::TITLE => "Create Users From CSV Import",
        self::MENU_LIST => "Admin::Users::CSV Import",
  ...
  protected function handle(Request $request)
  {
    ...
    return $this->render("users_from_csv.html.twig", $this->mergeWithDefault($vars));
  }
...
register_plugin(new UsersFromCSV());
